...
def create_users():
    with app.app_context():
        ...
        profile1 = Profile(id=1, avatar="https://scontent-mia1-1.xx.fbcdn.net/v/t1.0-1/p40x40/12208487_10153305128458380_4762134821855593042_n.jpg?oh=46fb02bcf716c4fafa4c0e8d6a5b4ac7&oe=587158D8", user_id=1, d_amount=0)
        # user 2
        ...
        db.session.add_all([u1,profile1,u2,u3,profile2,u4,u5,profile3,u6,u7,profile4,u8,u9,profile5,u10,u11,profile6])
        db.session.commit()
...
def create_bet():
    ...
    profile2.bets_taken += 1
    profile3.bets_taken += 1
    db.session.add_all([bet1,bet2,bet3,bet4,bet5,bet6,profile1,profile2,profile3,profile4,profile5,profile6])
    db.session.commit()
