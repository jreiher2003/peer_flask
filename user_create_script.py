...
def create_users():
    with app.app_context():
        user1 = Users(id=1,username="j3ff_", email="jeffreiher@gmail.com", password=encrypt_password("password"))
        role1 = Role(id=1,name="admin")
        role2 = Role(id=2,name="seller")
        role3 = Role(id=3,name="buyer")
        ...
        user2 = Users(id=2, username="ken", email="ken@gmail.com", password=encrypt_password("password"))
        ...
        user3 = Users(id=3, username="Mike", email="mike@gmail.com", password=encrypt_password("password"))
        ...
        user4 = Users(id=4, username="Greg", email="greg@gmail.com", password=encrypt_password("password"))
        ...
        user5 = Users(id=5, username="Rob", email="rob@gmail.com", password=encrypt_password("password"))
