...
def create_bet():
    bet1 = OverUnderBet(bet_key=1, game_key=201610321, over_under="o", total=40.5, amount=20, user_id=1)
    bet4 = OverUnderBet(bet_key=4, game_key=201610233, over_under="u", total=40.5, amount=10, user_id=1)
